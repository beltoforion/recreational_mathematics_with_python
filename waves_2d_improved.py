...
def init_simulation():
    ...
    # u[1, x-2:x+2, y-2:y+2] = 250
    # u[2, x-2:x+2, y-2:y+2] = 250
            

#    x = 260
#    y = 260
#    u[0, x-5:x+5, y-5:y+5] += gauss_peak
...
def update(u, alpha, algo):
    ...
    if algo==0: # ok, 2nd Order
        ...
        u[0, 1:dimx-1, 1:dimy-1] = alpha[1:dimx-1, 1:dimy-1] \
                                ...
                                + 2 * u[1, 1:dimx-1, 1:dimy-1] \
                                -     u[2, 1:dimx-1, 1:dimy-1]
    elif algo==3: # ok, (4)th Order https://www.ams.org/journals/mcom/1988-51-184/S0025-5718-1988-0935077-0/S0025-5718-1988-0935077-0.pdf; Page 702
    ...
    elif algo==4: # ok, (6th) https://www.ams.org/journals/mcom/1988-51-184/S0025-5718-1988-0935077-0/S0025-5718-1988-0935077-0.pdf; Page 702
    ...
    elif algo==5: # ok, (8th) https://www.ams.org/journals/mcom/1988-51-184/S0025-5718-1988-0935077-0/S0025-5718-1988-0935077-0.pdf; Page 702
...
#    freq = (1.01 + math.cos(0.002*tick)) / 2 * 0.2
    #print(f"freq: {freq}")
#    u[0, 50, int(dimy/2)-20] = math.sin(tick * freq) * 200
#    u[0, 50, int(dimy/2)+20] = math.sin(tick * 0.3) * 200
#    uu[0, 50, int(dimy/2)-20] = math.sin(tick * freq) * 200
#    uu[0, 50, int(dimy/2)+20] = math.sin(tick * 0.3) * 200
...
#        u[0, x-w:x+h, y-w:y+h] += height * gauss_peak
#        u[1, x-w:x+h, y-w:y+h] += height * gauss_peak
#        u[2, x-w:x+h, y-w:y+h] += height * gauss_peak        
        
#        uu[0, x-w:x+h, y-w:y+h] += height * gauss_peak
#        uu[1, x-w:x+h, y-w:y+h] += height * gauss_peak
#        uu[2, x-w:x+h, y-w:y+h] += height * gauss_peak

        u[0, x-1:x+1, y-1:y+1] = 300
        uu[0, x-1:x+1, y-1:y+1] = 300        
